...
<Form :model="formItem" :label-width="100">
  <FormItem label="姓名" class="formItem">
  ...
  <FormItem label="性别" class="formItem">
    <Select v-model="formItem.select">
      ...
      <Option value="shenzhen">保密</Option>
    </Select>
  </FormItem>
  ...
  <FormItem class="formItem">
    <Button type="primary" v-on:click="$emit('default_info')">Submit</Button>
    <Button style="margin-left: 8px" v-on:click="$emit('default_info')">Cancel</Button>
  </FormItem>
</Form>
</template>
<script>
